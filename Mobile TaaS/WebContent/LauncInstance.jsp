...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa fa-bars"></i> Launch Instance</h3>
					<ol class="breadcrumb">
			 ...
			 <br>
			   <h4>The configuration of virtual machine you ordered is : </h4> 
			  <br>==========================================================================================================<br>
			
			  <br> <h4>Region: <%= region%> </h4>
			  <br> <h4> Algorithmm: Honey Bee Optimization </h4>
			  <br> <h4>Ram(in MB): <%= ram%></h4>
			  <br> <h4>Operating System : <%= os%></h4>
			  <br> <h4>bit(32/64) : <%= bit%></h4>
			  <br> <h4>No of instance : <%= instance%></h4>
			  <br> <h4>Storage Memory(GB) : <%= cpumemory%></h4>
			  
			  <br><br>==========================================================================================================<br>
			  <br> <h4>Now, click below button to launch an instance </h4><br>
			  <form method="post"  action="testmain">
			  <tr>
			  <td colspan="2">
			  <input class="btn btn-primary" type="submit" value="Launch Instance">
			  </td>
			  <td colspan="2">
