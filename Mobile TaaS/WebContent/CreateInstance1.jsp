  ...
  <section id="container" class="">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a class="" href="grids.html">Mobile Test Applications</a></li>
                      </ul>
      ...
      <section id="main-content">
		...
		<option id="8" value="ap-northeast-1">ap-northeast-1</option>
                                      ...
                                      <div class="form-group ">
                                          <label for="cemail" class="control-label col-lg-2">RAM <span class="required">*</span></label>
                                          <div class="col-lg-10">
		...
		<option id="3" value="4">4 </option>
		<option id="5" value="8">8</option>
		<option id="6" value="16">16</option>
		<option id="7" value="32">32</option>
		</select>
                                          </div>
                                      </div>
                                      <div class="form-group ">
