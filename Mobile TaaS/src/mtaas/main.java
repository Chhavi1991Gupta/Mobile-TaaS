      ...
      System.out.println("#1 Create Amazon Client object");
        ...
        try {
         ...
         System.out.println("#2 Describe Availability Zones.");
            ...
            AuthorizeSecurityGroupIngressRequest r2 = new AuthorizeSecurityGroupIngressRequest(Temp_Group,permissions);
...
//            bufferedWriter.close(); 
            ...
            String imageId = "ami-c49c0dac";//  change to SUSE 64 bit Amazon AMI 
            ...
            for (Instance ins : resultInstance){
             ...
             System.out.println("New instance has been created: "+ins.getInstanceId());//print the instance ID
               ...
               /*********************************************
                ...
                newVolumeRequest.setAvailabilityZone(availabilityZonesResult.getAvailabilityZones().get(1).toString());// set its available zone, it may change.
